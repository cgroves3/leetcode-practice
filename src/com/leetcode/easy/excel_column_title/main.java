...
//        System.out.println(solution.convertToTitle(53));
        ...
        System.out.println(solution.convertToTitle(676));
        System.out.println(solution.convertToTitle(701));

        System.out.println(solution.convertToTitle(1000000));
        System.out.println(solution.convertToTitle((int)Math.pow(26,3)));
        System.out.println(solution.convertToTitle((int)Math.pow(26,5)));
    }
}
